(function (root, factory) {
    ...
    function createNormalizer(options) {
        ...
        var charsToLeaveAlone = options.leaveAlone || '';
        ...
        for (var charCode = 0 ; charCode < 256 ; charCode += 1) {
            ...
            if (charsToLeaveAlone.indexOf(ch) === -1 && ch !== encodeURIComponent(ch)) {
    ...
    var defaultNormalizer = createNormalizer();
    defaultNormalizer.create = createNormalizer;
